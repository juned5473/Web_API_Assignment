...
namespace Web_API_Assignment.Controllers
{
    ...
    public class TokenController : ControllerBase
    {
        ...
        private async Task<LoginInfo> GetUser(string email, string password)
        {
            return await _context.EmployeeInfo.FirstOrDefaultAsync(u => u.Email == email && u.Password == password);
